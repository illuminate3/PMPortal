			...
			<table class="etable table-condensed table-hover project-show full">
						...
						@foreach ($milestones as $milestone)
							...
							@else
								...
								@else
									@if (Auth::user()->id == $project->user_id)
									<td class="right"><a href="{{ action('MilestonesController@edit', [$milestone->project_id, $milestone->id] ) }}" title="Edit milestone"><img src="{{ asset('img/glyphicons-31-pencil.png')}}" style="width:10px;" > </img></a></td>
									<td class="right">
							...
							data-btn-cancel-label="Cancel" data-btn-cancel-icon="glyphicon glyphicon-ban-circle" data-title="<center><b>Are you sure you want to delete this milestone?</b></center>" type="image" name="image" src="{{ asset('img/glyphicons-17-bin.png')}}" style="width:10px;" >
							...
							<td class="span11">
								...
								@else
									...
									@else
										...
										<a href="{{ action('AccomplishmentsController@edit', [$accomplishment->project_id, $accomplishment->id] ) }}" title="Edit accomplishment"><img src="{{ asset('img/glyphicons-31-pencil.png')}}" style="width:10px;" > </img></a>
										</td>
										<td class="span1">
											{!! Form::open(['route' => ['accomplishments.destroy', $accomplishment->project_id, $accomplishment->id], 'method' => 'delete', 'class' => 'delete']) !!}
	     									<input data-singleton="true" data-popout="true" data-toggle="confirmation" data-placement="top"
							data-btn-ok-label="Delete" data-btn-ok-icon="glyphicon glyphicon-trash" data-btn-ok-class="btn-warning"
							data-btn-cancel-label="Cancel" data-btn-cancel-icon="glyphicon glyphicon-ban-circle" data-title="<center><b>Are you sure you want to delete this accomplishment?</b></center>" type="image" name="image" src="{{ asset('img/glyphicons-17-bin.png')}}" style="width:10px;" >
					...
					@foreach ($actions as $action)
						<tr>
							...
							@else
								...
								@else
									@if (Auth::user()->id == $project->user_id)
									<td><a href="{{ action('ActionsController@edit', [$action->project_id, $action->id] ) }}" title="Edit action"><img src="{{ asset('img/glyphicons-31-pencil.png')}}" style="width:10px;" > </img></a></td>
									<td>
										{!! Form::open(['route' => ['actions.destroy', $action->project_id, $action->id], 'method' => 'delete', 'class' => 'delete' ]) !!}
     									<input data-singleton="true" data-popout="true" data-toggle="confirmation" data-placement="top"
							data-btn-ok-label="Delete" data-btn-ok-icon="glyphicon glyphicon-trash" data-btn-ok-class="btn-warning"
							data-btn-cancel-label="Cancel" data-btn-cancel-icon="glyphicon glyphicon-ban-circle" data-title="<center><b>Are you sure you want to delete this action?</b></center>" type="image" name="image" src="{{ asset('img/glyphicons-17-bin.png')}}" style="width:10px;" >
					...
					@foreach ($issues as $issue)
						<tr>
							...
							@else
								...
								@else
									@if (Auth::user()->id == $project->user_id)
									<td><a href="{{ action('IssuesController@edit', [$issue->project_id, $issue->id] ) }}" title="Edit issue"><img src="{{ asset('img/glyphicons-31-pencil.png')}}" style="width:10px;" > </img></a></td>
									<td>
										{!! Form::open(['route' => ['issues.destroy', $issue->project_id, $issue->id], 'method' => 'delete', 'class' => 'delete' ]) !!}
     									<input data-singleton="true" data-popout="true" data-toggle="confirmation" data-placement="top"
							data-btn-ok-label="Delete" data-btn-ok-icon="glyphicon glyphicon-trash" data-btn-ok-class="btn-warning"
							data-btn-cancel-label="Cancel" data-btn-cancel-icon="glyphicon glyphicon-ban-circle" data-title="<center><b>Are you sure you want to delete this issue?</b></center>" type="image" name="image" src="{{ asset('img/glyphicons-17-bin.png')}}" style="width:10px;" >
					...
					@foreach ($risks as $risk)
						<tr>
							...
							@else
								...
								@else
									@if (Auth::user()->id == $project->user_id)
									<td><a href="{{ action('RisksController@edit', [$risk->project_id, $risk->id] ) }}" title="Edit risk"><img src="{{ asset('img/glyphicons-31-pencil.png')}}" style="width:10px;" > </img></a></td>
									<td>
										{!! Form::open(['route' => ['risks.destroy', $risk->project_id, $risk->id], 'method' => 'delete', 'class' => 'delete' ]) !!}
     									<input data-singleton="true" data-popout="true" data-toggle="confirmation" data-placement="top"
							data-btn-ok-label="Delete" data-btn-ok-icon="glyphicon glyphicon-trash" data-btn-ok-class="btn-warning"
							data-btn-cancel-label="Cancel" data-btn-cancel-icon="glyphicon glyphicon-ban-circle" data-title="<center><b>Are you sure you want to delete this risk?</b></center>" type="image" name="image" src="{{ asset('img/glyphicons-17-bin.png')}}" style="width:10px;" >
					...
					@foreach ($expenses as $expense)
						<tr>
							...
							@else
								...
								@else
									@if (Auth::user()->id == $project->user_id)
									<td><a href="{{ action('ExpensesController@edit', [$expense->project_id, $expense->id] ) }}" title="Edit expense"><img src="{{ asset('img/glyphicons-31-pencil.png')}}" style="width:10px;" > </img></a></td>
									<td>
										{!! Form::open(['route' => ['expenses.destroy', $expense->project_id, $expense->id], 'method' => 'delete', 'class' => 'delete' ]) !!}
     									<input data-singleton="true" data-popout="true" data-toggle="confirmation" data-placement="top"
							data-btn-ok-label="Delete" data-btn-ok-icon="glyphicon glyphicon-trash" data-btn-ok-class="btn-warning"
							data-btn-cancel-label="Cancel" data-btn-cancel-icon="glyphicon glyphicon-ban-circle" data-title="<center><b>Are you sure you want to delete this expense?</b></center>" type="image" name="image" src="{{ asset('img/glyphicons-17-bin.png')}}" style="width:10px;" >
